...
BozoUIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(80,80,80)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0,45,180))}
...
Arraylist = {
    Add = function(Name, Settings)
        ...
        UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(80,80,80)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0,45,180))}
        ...
        shadow.TextColor3 = Color3.fromRGB(70, 70, 70)
        print(sizee)
        shadow.Size = UDim2.new(0,shadowsize,0.99,1)
        shadow.AutomaticSize = "X"
        local textUIGradient = Instance.new("UIGradient", shadow)
        textUIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(80,80,80)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0,45,180))}
