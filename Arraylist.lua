...
BozoUIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(70,70,70)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 40.3, 150))}
...
Arraylist = {
    Add = function(Name, Settings)
        ...
        UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(70,70,70)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 40.3, 150))}
        ...
        textUIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(70,70,70)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 40.3, 150))}
