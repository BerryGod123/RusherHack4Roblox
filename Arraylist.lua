...
Arraylist = {
    Add = function(Name, Settings)
        ...
        local sizee
        if Settings then
            sizee = game:GetService("TextService"):GetTextSize(Name .. " " .. Settings, TextScale, Enum.Font.SourceSansBold, Vector2.new(1000000, 1000000))
        else
            sizee = game:GetService("TextService"):GetTextSize(Name, TextScale, Enum.Font.SourceSansBold, Vector2.new(1000000, 1000000))
        end
