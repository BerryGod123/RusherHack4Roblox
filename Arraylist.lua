...
topframe.Position = UDim2.new(0.88245, 0, 0, 0)
topframe.BorderSizePixel = 0
topframe.BackgroundTransparency = 0
topframe.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
local BozoUIGradient = Instance.new("UIGradient")
BozoUIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(100,100,100)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0,45,210))}
...
Arraylist = {
    Add = function(Name, Settings)
        ...
        UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(100,100,100)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0,45,210))}
        ...
        textUIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(100,100,100)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0,45,210))}
