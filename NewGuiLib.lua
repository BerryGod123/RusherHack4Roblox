...
Frame_2.Size = UDim2.new(0, 0, 0, 3)
...
function lib:CreateWindow()
    ...
    function lib:CreateTab(title, color, asset)
        ...
        tabname.BackgroundColor3 = Color3.fromRGB(55,55,55)
        tabname.BackgroundTransparency = 0.000
        ...
        function tabtable:CreateToggle(data)
            ...
            local BindText
                ...
                optionframe.BorderColor3 = Color3.fromRGB(170, 0, 255)
            ...
            function sussyamog:CreateSlider(argstable)
                ...
                slidertext.Position = UDim2.new(0.0188679248, 0, 0.05, 0)
